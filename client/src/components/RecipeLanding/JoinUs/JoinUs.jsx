        ...
        <Col md="8" lg="11" xs="12">
          <div className="rgba-stylish-strong layerColor">
            ...
            <p>
              ...
              {'voluptates praesentium quia, quae, dolor aperiam possimus architecto, '}
              {'tempore unde! Quasi fugit voluptate, maiores adipisci commodi nemo rem cumque.'}
            </p>
            <p>
              {'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Error eum mollitia sit '}
              {'dolorem autem qui possimus ex voluptate, voluptatibus iste unde numquam '}
              {'illum, molestiae reprehenderit, eligendi. Illum quod esse voluptatibus.'}
            </p>
